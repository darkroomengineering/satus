...
export function useViewport<T>(selector?: (state: ViewportValues) => T): ViewportValues | T {
  ...
  return useSyncExternalStore(subscribe, getSnapshotWithSelector, getServerSnapshotWithSelector);
}
