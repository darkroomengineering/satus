...
import { getUnconfiguredIntegrations } from '~/lib/lib/integrations/check-integration'
...
export const REMOVAL_GUIDE: Record<string, RemovalGuide> = {
  ...
  Mailchimp: {
    dirs: ['lib/integrations/mailchimp'],
    pages: [],
    notes: 'Remove Mailchimp-related form handlers',
  },
  Mandrill: {
    dirs: ['lib/integrations/mandrill'],
    pages: [],
  ...
  Turnstile: {
    ...
    pages: [],
    notes:
      'Remove Turnstile validation from lib/integrations/mailchimp/turnstile.ts',
  },
  Analytics: {
    dirs: [],
    pages: [],
