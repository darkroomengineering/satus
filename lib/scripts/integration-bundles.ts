...
export const INTEGRATION_BUNDLES: Record<string, IntegrationBundle> = {
  sanity: {
    ...
    folders: ['lib/integrations/sanity', 'app/studio', 'app/(pages)/(sanity)'],
    files: ['components/sanity-image/index.tsx'],
  ...
  shopify: {
    ...
    dependencies: [],
    devDependencies: [],
    folders: ['lib/integrations/shopify', 'app/(pages)/shopify'],
    files: [],
  ...
  hubspot: {
    ...
    folders: ['lib/integrations/hubspot', 'app/(pages)/hubspot'],
    files: [],
    configPatterns: [],
  ...
  webgl: {
    ...
    folders: ['lib/webgl', 'app/(pages)/r3f'],
    files: ['components/animated-gradient/webgl.tsx'],
